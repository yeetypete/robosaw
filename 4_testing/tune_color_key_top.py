...
# for S,V its 0-255.
cv2.createTrackbar("L - H", "Trackbars", h_lower_thresh2, 179, nothing)
cv2.createTrackbar("L - S", "Trackbars", s_lower_thresh2, 255, nothing)
cv2.createTrackbar("L - V", "Trackbars", v_lower_thresh2, 255, nothing)
cv2.createTrackbar("U - H", "Trackbars", h_upper_thresh2, 179, nothing)
cv2.createTrackbar("U - S", "Trackbars", s_upper_thresh2, 255, nothing)
cv2.createTrackbar("U - V", "Trackbars", v_upper_thresh2, 255, nothing)
